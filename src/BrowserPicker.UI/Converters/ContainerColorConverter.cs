...
public sealed class ContainerColorConverter : IValueConverter
{
	...
	private static readonly FrozenDictionary<string, SolidColorBrush> ColorMap = new Dictionary<string, SolidColorBrush>
	{
...
public sealed class ContainerIconConverter : IValueConverter
{
	...
	static ContainerIconConverter()
	{
		var dict = new Dictionary<string, Geometry>(StringComparer.OrdinalIgnoreCase)
		{
			...
			["briefcase"] = G(
				"M 2,6 H 14 V 14 H 2 Z  M 5.5,6 V 3.5 C 5.5,2.7 6.2,2 7,2 H 9 C 9.8,2 10.5,2.7 10.5,3.5 V 6"
			),
			["dollar"] = G(
			...
			["fence"] = G("M 3,3 V 13  M 6.5,2 V 13  M 10,3 V 13  M 13.5,2 V 13  " + "M 1,6 H 15  M 1,10 H 15"),
			["gift"] = G(
