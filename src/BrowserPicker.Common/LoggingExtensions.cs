...
public static partial class LoggingExtensions
{
	...
	public static partial void LogDefaultSettingAdded(
		this ILogger logger,
		string matchType,
		string pattern,
		string? browser
	...
	[LoggerMessage(
		...
		Message = "Lookup of configured defaults returned browser: {Choice}"
	)]
	...
	[LoggerMessage(
		EventId = 1016,
		Level = LogLevel.Information,
		Message = "Browser {BrowserName} was selected, running is: {IsRunning}"
	)]
	...
	public static partial void LogAutomationInputs(
		this ILogger logger,
		string? url,
		bool alwaysPrompt,
		bool alwaysUseDefaults,
		bool alwaysAskWithoutDefault,
		bool useFallbackDefault,
	...
	public static partial void LogAutomationMatchCandidate(
		this ILogger logger,
		string matchType,
		string? pattern,
		string? browser,
	...
	[LoggerMessage(
		EventId = 1023,
		Level = LogLevel.Debug,
		Message = "Chosen default browser key: {MatchedKey} ({Source})"
	)]
	...
	public static partial void LogAutomationResolvedBrowser(
		this ILogger logger,
		string? matchedKey,
		string? browserId,
		string? browserName,
	...
	public static partial void LogAutomationUsingConfiguredBrowser(
		this ILogger logger,
		string? browserName,
		bool alwaysUseDefaults,
		bool? isRunning
	...
	public static partial void LogAutomationSkippingConfiguredBrowser(
		this ILogger logger,
		string? browserName,
		bool alwaysUseDefaults,
		bool? isRunning
	...
	[LoggerMessage(
		EventId = 1027,
		Level = LogLevel.Debug,
		Message = "Running browsers considered for fallback: {Browsers}"
	)]
	...
	[LoggerMessage(
		EventId = 1028,
		Level = LogLevel.Debug,
		Message = "Returning single running browser fallback: {BrowserName}"
	)]
