...
public sealed class Vivaldi : IWellKnownBrowser
{
	public static readonly Vivaldi Instance = new();

	public string Name => "Vivaldi";

	public string Executable => "vivaldi.exe";
	...
	public string UserDataPath => @"Vivaldi\User Data";
}