...
public interface IBrowserPickerConfiguration : IApplicationSettings, INotifyPropertyChanged, ILongRunningProcess
{
	...
	/// This makes Browser Picker only seemingly apply for certain urls.
	/// </summary>
	...
	/// </summary>
	/// <param name="_">The browser that was edited; some backends persist the full settings document and ignore this reference.</param>
	void PersistBrowser(BrowserModel _);
